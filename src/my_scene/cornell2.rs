...
pub fn get_scene() -> Scene {
    ...
    let green   = PhongMaterial        { k_a: 0.0, k_d: 0.9, k_s: 0.1, k_dg: 0.5, k_sg: 0.0, k_tg: 0.0, shininess: 10.0,                       ior: 0.7,  ambient: Vec3::one(), diffuse: Vec3 { x: 0.0, y: 1.0, z: 0.0 }, specular: Vec3::one(), transmission: Vec3::zero(), diffuse_texture: None };
    let red     = PhongMaterial        { k_a: 0.0, k_d: 0.9, k_s: 0.1, k_dg: 0.5, k_sg: 0.0, k_tg: 0.0, shininess: 10.0,                       ior: 0.7,  ambient: Vec3::one(), diffuse: Vec3 { x: 1.0, y: 0.0, z: 0.0 }, specular: Vec3::one(), transmission: Vec3::zero(), diffuse_texture: None };
    ...
    let refract = CookTorranceMaterial { k_a: 0.0, k_d: 0.0, k_s: 0.0, k_dg: 0.0, k_sg: 0.0, k_tg: 1.0, gauss_constant: 5.0, roughness: 0.01,  ior: 3.0,  ambient: Vec3::one(), diffuse: Vec3 { x: 1.0, y: 1.0, z: 1.0 }, specular: Vec3 { x: 0.9, y: 0.9, z: 0.9 }, transmission: Vec3 { x: 0.8, y: 0.8, z: 0.8 }, diffuse_texture: None };
    ...
    prims.push(box Sphere { center: Vec3 { x: 50.0, y: 50.0, z: 15.0 }, radius: 10.0, material: box white.clone() });
