...
fn main() {
    ...
    let grey  = FlatMaterial {color: Vec3 {x: 0.6, y: 0.6, z: 0.6}};
    let red   = FlatMaterial {color: Vec3 {x: 1.0, y: 0.0, z: 0.0}};
    let green = FlatMaterial {color: Vec3 {x: 0.0, y: 1.0, z: 0.0}};
    let blue  = FlatMaterial {color: Vec3 {x: 0.0, y: 0.0, z: 1.0}};
